...
DEFINE_LOG_CATEGORY(SkeletalAndPoseableMeshComponent);



void USkeletalAndPoseableMeshComponent::BeginPlay()
{
	Super::BeginPlay();
}

void USkeletalAndPoseableMeshComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
	Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
}

bool USkeletalAndPoseableMeshComponent::AllocateTransformData()
{
...
void USkeletalAndPoseableMeshComponent::RefreshBoneTransforms(FActorComponentTickFunction* TickFunction)
{
...
void USkeletalAndPoseableMeshComponent::FillComponentSpaceTransforms()
{
...
void USkeletalAndPoseableMeshComponent::SetBoneTransformByName(FName BoneName, const FTransform& InTransform, EBoneSpaces::Type BoneSpace)
{
...
void USkeletalAndPoseableMeshComponent::SetBoneLocationByName(FName BoneName, FVector InLocation, EBoneSpaces::Type BoneSpace)
{
...
void USkeletalAndPoseableMeshComponent::SetBoneRotationByName(FName BoneName, FRotator InRotation, EBoneSpaces::Type BoneSpace)
{
	FTransform CurrentTransform = GetBoneTransformByName(BoneName, BoneSpace);
...
void USkeletalAndPoseableMeshComponent::SetBoneScaleByName(FName BoneName, FVector InScale3D, EBoneSpaces::Type BoneSpace)
{
	FTransform CurrentTransform = GetBoneTransformByName(BoneName, BoneSpace);
...
FTransform USkeletalAndPoseableMeshComponent::GetBoneTransformByName(FName BoneName, EBoneSpaces::Type BoneSpace)
{
	if (!SkeletalMesh || !RequiredBones.IsValid())
	{
		return FTransform();
...
FVector USkeletalAndPoseableMeshComponent::GetBoneLocationByName(FName BoneName, EBoneSpaces::Type BoneSpace)
{
	FTransform CurrentTransform = GetBoneTransformByName(BoneName, BoneSpace);
	return CurrentTransform.GetLocation();
}

FRotator USkeletalAndPoseableMeshComponent::GetBoneRotationByName(FName BoneName, EBoneSpaces::Type BoneSpace)
{
	FTransform CurrentTransform = GetBoneTransformByName(BoneName, BoneSpace);
	return FRotator(CurrentTransform.GetRotation());
}

FVector USkeletalAndPoseableMeshComponent::GetBoneScaleByName(FName BoneName, EBoneSpaces::Type BoneSpace)
{
	FTransform CurrentTransform = GetBoneTransformByName(BoneName, BoneSpace);
	return CurrentTransform.GetScale3D();
}

void USkeletalAndPoseableMeshComponent::ResetBoneTransformByName(FName BoneName)
{
	if (!SkeletalMesh)
	{
		return;
...
void USkeletalAndPoseableMeshComponent::CopyPoseFromSkeletalComponent(const USkeletalMeshComponent* InComponentToCopy)
{
